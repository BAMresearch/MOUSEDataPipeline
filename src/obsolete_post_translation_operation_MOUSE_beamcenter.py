...
def main(
    ...
    center_of_mass, ITotal_region, ITotal_overall, ellipse_mask, sigma_minor, sigma_major, theta = (
        determine_beam_center(imageData, coverage=0.997, ellipse_mask=ellipse_mask)
    )

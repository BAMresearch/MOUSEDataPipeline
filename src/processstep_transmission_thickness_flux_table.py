...
def run(dir_path: Path, defaults: DefaultsCarrier, logbook_reader: LogbookReaderLike | None, logger: logging.Logger):
    ...
    output_file = dir_path.parent / "MOUSE_flux_thickness_table.csv"
    ...
    try:
        ...
        data = {
            ...
            "transmission_correction_factor": get_float_from_h5(
                input_file, "/entry1/sample/transmission_correction_factor", logger
            ),
            "scattering_probability": get_float_from_h5(
                input_file, "/entry1/sample/scattering_probability_estimate", logger
            ),
            ...
            "absorption_derived_thickness": get_float_from_h5(
                input_file, "/entry1/sample/absorptionDerivedThickness", logger
            ),
        }

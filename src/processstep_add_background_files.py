...
def run(dir_path: Path, defaults: DefaultsCarrier, logbook_reader: Logbook2MouseReader, logger: logging.Logger):
    ...
    try:
        ...
        with h5py.File(input_file, 'a') as h5f:
            ...
            bg_file_dataset.attrs.update({'note': 'background filename added by MOUSEDataPipeline, relative to preprocessed, stacked, file'})
            ...
            dbg_file_dataset.attrs.update({'note': 'dispersed background filename added by MOUSEDataPipeline, relative to preprocessed, stacked, file'})
